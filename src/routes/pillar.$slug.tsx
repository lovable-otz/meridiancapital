            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {SUBURBS.map((s) => (
                <Link
                  ...
                  className="group flex min-w-0 items-center justify-between gap-3 rounded-xl border border-border bg-card p-4 transition-all hover:-translate-y-0.5 hover:border-[color:var(--brand-blue)]/40 hover:shadow-sm"
                >
                  ...
                  <MapPin className="h-4 w-4 shrink-0 text-[color:var(--brand-blue)]" />
                </Link>
              ))}
            </div>
          </div>
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {related.map((p) => (
              <Link
                ...
                to="/pillar/$slug"
                params={{ slug: p.slug }}
                className="group flex min-w-0 items-start justify-between gap-3 rounded-xl border border-border bg-card p-4 transition-all hover:-translate-y-0.5 hover:border-[color:var(--brand-blue)]/40 hover:shadow-sm"
              >
                <div className="min-w-0">
