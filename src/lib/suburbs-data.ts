...
export const SUBURBS: Suburb[] = [
  ...
  },
  {
    ...
    intro:
      "Wynwood is Miami's creative district: a former garment-and-warehouse neighborhood now built around the Wynwood Walls, dozens of independent galleries, craft breweries, design-forward restaurants and a fast-growing technology cluster anchored by Wynwood Plaza, The Annex and a wave of remote-first venture-backed teams. Briarcliff Advances finances Wynwood operators with structures that match the district's mix of high-rent creative real estate, hospitality cash flow, and fast-scaling tech revenue.",
