...
export const INDUSTRIES: Industry[] = [
  {
    ...
    services: [
      ...
      make(
        ...
        "Seasonal-friendly structures tailored to Homestead-Redland farm cash flow, with deferred payments aligned to harvest cycles.",
      ...
      make(
        ...
        "Build out your Miami landscaping fleet with financing built for year-round operations — South Florida crews don't shut down for winter.",
  ...
  },
  {
    ...
    services: [
      ...
      make(
        ...
        "Finance the truck, the build-out and the commissary kitchen — Miami's year-round event calendar keeps food trucks running 12 months a year.",
  ...
  },
  {
    ...
    services: [
      ...
      make(
        ...
        Dumbbell,
        "Equipment & build-out",
        "Outfit the floor, expand into recovery and group fitness, or refinance higher-rate equipment leases — Miami is one of the densest boutique-fitness markets in the U.S.",
